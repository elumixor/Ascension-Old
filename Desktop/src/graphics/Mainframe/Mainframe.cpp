...
Mainframe::Mainframe() {
    ...
    matrices.projection = glm::perspective(glm::radians(PARAMS::persepctive_zoom),
                                           (float) PARAMS::window_width / (float) PARAMS::window_height, 0.1f, 100.0f);
    matrices.view = glm::lookAt(glm::vec3(0.f, 0.f, 1.f), glm::vec3(0.f, 0.f, 0.f), glm::vec3(0.f, 1.f, 0.f));
}
